...
{
	RegisterCard<IndiaInkCard>(L"먹물", L"상대턴에 먹물을 뿌립니다.", L"IndialnkIcon", CardRarity::Normal);
	RegisterCard<EarthquakeCard>(L"지진", L"상대턴에 지진을 일으킵니다", L"EarthquakeIcon", CardRarity::Normal);
	RegisterCard<PlaceMineCard>(L"지뢰", L"지뢰를 설치하며, 지뢰가 있는 자리에는 돌을 둘 수 없습니다.", L"PlaceMineIcon", CardRarity::Normal);
	RegisterCard<TimeStopCard>(L"타이무스토뿌", L"사용 즉시 본인의 시간을 멈춥니다.", L"TimeStopIcon", CardRarity::Normal);
	RegisterCard<DeleteTimeCard>(L"시간 삭제", L"상대의 시간을 20초 가져 갑니다.", L"DeleteTimeIcon", CardRarity::Normal);
	RegisterCard<ReplaceRandomStoneSkill>(L"매수.", L"상대의 돌을 랜덤하게 매수합니다.", L"ReplaceRandomStoneIcon", CardRarity::Normal);
	RegisterCard<RerollCard>(L"리롤", L"카드를 다시 뽑습니다.", L"RerollIcon", CardRarity::Normal);
	RegisterCard<BlindAllStonesCard>(L"눈가리기", L"상대 턴에 모든 돌을 숨깁니다.", L"BlindAllStonesIcon", CardRarity::Normal);
